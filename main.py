...
def reset_session():
    ...
    global profit, loss_streak, current_stake
    global bot_running
    wins          = 0
    losses        = 0
    win_rate      = 0
...
def place_real_trade(signal_name):
    ...
    try:
        ...
        # ========================
            ...
            loss_streak   += 1
            current_stake  = round(
                current_stake * martingale_multiplier, 2
            )
            status_message(
                f"LOSS ${trade_profit} | "
        ...
        try:
            ...
            while True:
                ...
                if "tick" in data:
                    ...
                    if seconds_since_trade < trade_cooldown:
...
def dashboard():
    ...
    for item in trade_history:
        color = "lightgreen" if "WIN" in item else "#ff6b6b"
        history_html += (
